...
public class LHR_Past_Medical_bean {
    ...
    /**
     * @return the onset_data
     */
    public String getOnset_data() {
        return onset_data;
    }

    /**
     * @param onset_data the onset_data to set
     */
    public void setOnset_data(String onset_data) {
        this.onset_data = onset_data;
    }
    ...
    /**
     * @param icd10_cd the icd10_cd to set
     */
    ...
    /**
     * @param term_cd the term_cd to set
     */
